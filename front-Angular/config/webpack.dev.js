...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(svg)$/,
        use: 'file-loader?name=assets/svg/[name]-[hash:6].[ext]'
      },
      {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      { from: './angularApp/assets/icons', to: 'assets/icons', flatten: true },
      { from: './angularApp/assets/images', to: 'assets/images', flatten: true }
    ])
  ]
};
